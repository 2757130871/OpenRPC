...
extern HeadSizeDefaultTypeInternal _HeadSize_default_instance_;
class RpcHeader;
struct RpcHeaderDefaultTypeInternal;
extern RpcHeaderDefaultTypeInternal _RpcHeader_default_instance_;
}  // namespace pmrpc
PROTOBUF_NAMESPACE_OPEN
template<> ::pmrpc::HeadSize* Arena::CreateMaybeMessage<::pmrpc::HeadSize>(Arena*);
template<> ::pmrpc::RpcHeader* Arena::CreateMaybeMessage<::pmrpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace pmrpc {

// ===================================================================

class HeadSize final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:pmrpc.HeadSize) */ {
 public:
  inline HeadSize() : HeadSize(nullptr) {}
  ~HeadSize() override;
  explicit PROTOBUF_CONSTEXPR HeadSize(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  HeadSize(const HeadSize& from);
  HeadSize(HeadSize&& from) noexcept
    : HeadSize() {
    *this = ::std::move(from);
  }

  inline HeadSize& operator=(const HeadSize& from) {
    CopyFrom(from);
    return *this;
  }
  inline HeadSize& operator=(HeadSize&& from) noexcept {
  ...
  static const HeadSize& default_instance() {
    return *internal_default_instance();
  }
  static inline const HeadSize* internal_default_instance() {
    return reinterpret_cast<const HeadSize*>(
               &_HeadSize_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(HeadSize& a, HeadSize& b) {
    a.Swap(&b);
  }
  inline void Swap(HeadSize* other) {
  ...
  void UnsafeArenaSwap(HeadSize* other) {
    if (other == this) return;
  ...
  HeadSize* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<HeadSize>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const HeadSize& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const HeadSize& from) {
    HeadSize::MergeImpl(*this, from);
  }
  private:
  ...
  void InternalSwap(HeadSize* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "pmrpc.HeadSize";
  }
  protected:
  explicit HeadSize(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  enum : int {
    kHeadSizeFieldNumber = 1,
  };
  // uint32 head_size = 1;
  void clear_head_size();
  uint32_t head_size() const;
  void set_head_size(uint32_t value);
  private:
  uint32_t _internal_head_size() const;
  void _internal_set_head_size(uint32_t value);
  public:

  // @@protoc_insertion_point(class_scope:pmrpc.HeadSize)
 private:
  class _Internal;
...
class RpcHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:pmrpc.RpcHeader) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:pmrpc.RpcHeader)
 private:
  class _Internal;
...
// uint32 head_size = 1;
inline void HeadSize::clear_head_size() {
  _impl_.head_size_ = 0u;
}
inline uint32_t HeadSize::_internal_head_size() const {
  return _impl_.head_size_;
}
inline uint32_t HeadSize::head_size() const {
  // @@protoc_insertion_point(field_get:pmrpc.HeadSize.head_size)
  return _internal_head_size();
}
inline void HeadSize::_internal_set_head_size(uint32_t value) {
  
  _impl_.head_size_ = value;
}
inline void HeadSize::set_head_size(uint32_t value) {
  _internal_set_head_size(value);
  // @@protoc_insertion_point(field_set:pmrpc.HeadSize.head_size)
}
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:pmrpc.RpcHeader.service_name)
...
void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.service_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:pmrpc.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:pmrpc.RpcHeader.service_name)
  return _s;
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:pmrpc.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:pmrpc.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:pmrpc.RpcHeader.method_name)
...
void RpcHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.method_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:pmrpc.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:pmrpc.RpcHeader.method_name)
  return _s;
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:pmrpc.RpcHeader.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:pmrpc.RpcHeader.method_name)
}
...
inline uint32_t RpcHeader::arg_size() const {
  // @@protoc_insertion_point(field_get:pmrpc.RpcHeader.arg_size)
...
inline void RpcHeader::set_arg_size(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:pmrpc.RpcHeader.arg_size)
}
